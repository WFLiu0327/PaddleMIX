...
from ppdiffusers import AutoencoderKL, FlowMatchEulerDiscreteScheduler, SD3Transformer2DModel, StableDiffusion3Pipeline
...
class StableDiffusion3PipelineSlowTests(unittest.TestCase):
    ...
    def test_sd3_inference(self):
        pipe = StableDiffusion3Pipeline.from_pretrained(self.repo_id)
        pipe.set_progress_bar_config(disable=None)
